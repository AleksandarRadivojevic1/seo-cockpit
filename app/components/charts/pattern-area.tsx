...
export function PatternArea({
  ...
  return (
    <AreaClosed
      curve={curve}
      data={renderData}
      // LOCAL PATCH -- same gap fix as line.tsx and area.tsx. Without it a
      // date with no row is drawn at the axis instead of breaking the shape,
      // which reads as a measured zero. Re-apply after any
      // `shadcn add @bklit/area-chart`.
